...
- On a package timeout, the panic (`test timed out after …`) is copied onto the tests that were running, and the synthetic `TestMain` case that holds it is dropped.
